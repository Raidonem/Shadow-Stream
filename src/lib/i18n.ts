...
export const translations = {
  en: {
    ...
    reportSent: 'Report submitted successfully. Thank you!',
    reports: 'Reports',
    ...
    actionLogs: 'Moderation History',
    restrictedUntil: 'Comment restricted until {date}',
    suspendedUntil: 'Account suspended until {date}',
    forever: 'Forever',
    days: 'Days',
    year_label: 'Year',
    animeTypes: {
  ...
  ar: {
    ...
    reportSent: 'تم إرسال البلاغ بنجاح. شكراً لك!',
    reports: 'البلاغات',
