...
export const translations = {
  en: {
    ...
    reportServer: 'Report Server Issue',
    ...
    restrictedUntil: 'Comment restricted until: {date}',
  ...
  ar: {
    ...
    reportServer: 'إبلاغ عن مشكلة في السيرفر',
    ...
    restrictComments: 'تقييد التعليقات',
    suspendAccount: 'تعليق الحساب',
    restrictionDuration: 'مدة التقييد',
    suspensionDuration: 'مدة التعليق',
    warningMessage: 'رسالة تحذير مخصصة',
    sendWarning: 'إرسال التحذير',
    actionApplied: 'تم تطبيق الإجراء بنجاح.',
    accountSuspended: 'تم تعليق حسابك.',
    suspendedUntil: 'معلق حتى: {date}',
    restrictedUntil: 'التعليقات مقيدة حتى: {date}',
    viewWarning: 'عرض التحذير',
